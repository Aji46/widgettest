...
class _AudioInfoState extends State<AudioInfo> {
  String transcription = ""; // State to store the transcription
        ...
        child: Column(
          children: [
            ...
            WavedAudioPlayer(
              ...
              onTranscriptionReceived: _updateTranscription, // Pass callback
            ),
            const SizedBox(height: 30),
            Padding(
              padding: const EdgeInsets.all(16.0),
              child: Text(
                transcription.isEmpty
                    ? widget.audioFile.transcription
                    : transcription, // Display the updated transcription
                style: const TextStyle(fontSize: 16),
              ),
            ),
          ],
