...
//                                             Text(
//                                               audio.transcription : text("hallo"),
...
import 'package:test_widget/audio/presentation/view_audio/apicalss.dart';
import 'package:test_widget/audio/presentation/view_audio/audio_info.dart';
...
class _FileExploreScreenState extends State<FileExploreScreen> {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 15),
                ...subFolders.map((subFolder) => GestureDetector(
                      onTap: fetchAudioFiles, // Ideally should pass subfolder info if needed
                      child: Padding(
                        padding: const EdgeInsets.only(left: 30.0, bottom: 10),
                        child: Row(
                          children: [
                            const Icon(Icons.folder, color: Colors.amber),
                            const SizedBox(width: 8),
                            Text(subFolder.name, style: const TextStyle(fontSize: 16)),
                          ],
                        ),
                      ),
                    )),
  ...
  Navigator.push(
    context,
    MaterialPageRoute(
      builder: (_) => AudioInfo(file: audio.folderPath, fileName: audio.fileName, transcriptText: audio.transcription,
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(height: 8),
                                        Text(
                                          audio.transcription.isNotEmpty ? audio.transcription : "No transcription available",
                                          style: TextStyle(fontSize: 14, color: Colors.grey[700]),
                                        ),
                                      ],
                                    ),
